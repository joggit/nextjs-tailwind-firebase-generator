...
// Enhanced configuration templates with detailed fields
    ...
    sections: {
      hero: {
        ...
        fields: {
          ...
          heroImage: { type: 'text', label: 'Hero Image URL', placeholder: '/hero-image.jpg' },
          ...
          backgroundType: { type: 'select', label: 'Background Type', options: ['gradient', 'image', 'video', 'solid'] },
      ...
      features: {
        ...
        fields: {
          ...
          features: { type: 'list', label: 'Features', itemFields: {
      ...
      testimonials: {
        ...
        fields: {
          ...
          testimonials: { type: 'list', label: 'Testimonials', itemFields: {
      ...
      stats: {
        ...
        fields: {
          ...
          stats: { type: 'list', label: 'Statistics', itemFields: {
    ...
    sections: {
      ...
      mission: {
        ...
        fields: {
          ...
          values: { type: 'list', label: 'Company Values', itemFields: {
      ...
      team: {
        ...
        fields: {
          ...
          teamMembers: { type: 'list', label: 'Team Members', itemFields: {
  ...
  services: {
    sections: {
      ...
      services: {
        title: 'Services List',
        fields: {
          services: { type: 'list', label: 'Services', itemFields: {
      ...
      process: {
        ...
        fields: {
          ...
          processSteps: { type: 'list', label: 'Process Steps', itemFields: {
      ...
      pricing: {
        ...
        fields: {
          ...
          pricingPlans: { type: 'list', label: 'Pricing Plans', itemFields: {
    ...
    sections: {
      ...
      locations: {
        ...
        fields: {
          ...
          locations: { type: 'list', label: 'Locations', itemFields: {
      ...
      form: {
        ...
        fields: {
          ...
          formFields: { type: 'list', label: 'Form Fields', itemFields: {
...
function PageEditor({ config, onChange }) {
  ...
  useEffect(() => {
    ...
    console.log('Page config changed:', config)
  }, [initializePageStructures])
  ...
  }, [config.detailedPages, updatePageData, processPlaceholder, addListItem, updateListItem, removeListItem])
  ...
  }, [config.detailedPages, isInitialized, selectedPage, expandedSections, toggleSection, renderField, togglePageEnabled])
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-600 mb-6">Configure detailed content that will be interpolated into your page templates</p>
      </div>
