// Updated File Upload Component to use the working endpoint
// File: components/vector/FileUploadFixed.jsx
...
export function FileUploadFixed({ onUploadComplete, maxFiles = 10, acceptedTypes = '' }) {
  ...
  const uploadFiles = async () => {
    ...
    for (let i = 0; i < files.length; i++) {
      ...
      try {
        ...
        results.push({ file: file.name, success: true, result: result.data })
