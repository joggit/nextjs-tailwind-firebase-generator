...
class EcommercePagesGenerator {
  ...
  getEcommercePageFilePath(pageType) {
    const paths = {
      shop: 'app/ecommerce/shop/page.js',
      product: 'app/ecommerce/product/[id]/page.js',
      cart: 'app/ecommerce/cart/page.js',
      checkout: 'app/ecommerce/checkout/page.js',
      account: 'app/ecommerce/account/page.js'
    };
    
    return paths[pageType] || `app/ecommerce/${pageType}/page.js`;
  }
