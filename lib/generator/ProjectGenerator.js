// lib/generator/ProjectGenerator.js
...
export class ProjectGenerator {
    ...
    async generateProject(config) {
        ...
        try {
            // Use TemplatePathManager instead of local function
    ...
    // Remove this local function - now handled by TemplatePathManager
    // getTemplatePaths(template) {
    //   return {
    //     'components/Header.jsx': 'base/components/Header.jsx.template'
    //   };
    // }
    ...
    async generateFiles(templatePaths, config) {
        ...
        for (const [outputPath, templatePath] of Object.entries(templatePaths)) {
            try {
                ...
                files[outputPath] = `// Error: ${error.message}`;
            }
        }
